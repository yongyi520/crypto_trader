...
import { Binance } from '/imports/ui/components/exchange/binance/Binance.jsx';
...
export default ExchangeAPIContainer = compose(getTrackerLoader(reactiveMapper))(Binance);